...
import type { Subscription, PaginationMeta } from '@/types/subscription';
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-800">
          <h3 className="text-sm font-medium text-zinc-600 dark:text-zinc-400">Total Subscriptions</h3>
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-800">
          ...
          <p className="mt-2 text-3xl font-bold text-zinc-900 dark:text-zinc-50">
            {subscriptions.length} of {meta?.total || 0}
          </p>
        </div>
      </div>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm text-zinc-600 dark:text-zinc-400">
                          <div className="flex flex-col">
                            ...
                            <span className="text-xs">ID: {subscription.subscriber_id}</span>
                          </div>
                        </td>
                        <td className="px-6 py-4 text-sm text-zinc-600 dark:text-zinc-400">
